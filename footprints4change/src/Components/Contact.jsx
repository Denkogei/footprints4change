...
function Contact() {
  ...
  const handleSubmit = (e) => {
    ...
    if (validateForm()) {
      ...
      window.location.href = `mailto:info@footprints4change.org?subject=${encodeURIComponent(subject)}&body=${body}`;
      setIsSubmitted(true);
      setTimeout(() => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#2B256E] to-[#88C641] px-4 sm:px-6 lg:px-8 pt-24">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    className={`w-full px-4 py-2 border rounded-md focus:ring-2 focus:ring-[#2B256E] focus:border-[#2B256E] ${errors.subject ? 'border-red-500' : 'border-gray-300'}`}
